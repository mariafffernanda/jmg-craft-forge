...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can request a quote by filling out our contact form, calling us at (305) 218-5311, or emailing us at info@jmgcustommetalshop.com. Please provide details about your project including dimensions, materials, and any specific requirements."
    },
    {
